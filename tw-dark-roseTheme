...
const topbar_font_color = COLORS.dustyRose; // HREFs

const buttons_hover_color = COLORS.darkGray; // btn hovers
const buttons_color = COLORS.dustyRose; // Buttons + some fonts
...
const input_font_color = COLORS.dustyRose; // input text font
